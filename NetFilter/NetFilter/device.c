...
#pragma NDIS_INIT_FUNCTION(NetFilterRegisterDevice)
    ...
    )
{
    ...
    DEBUGP(DL_TRACE, "==>NetFilterRegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = NetFilterDispatch;
    DispatchTable[IRP_MJ_CLEANUP] = NetFilterDispatch;
    DispatchTable[IRP_MJ_CLOSE] = NetFilterDispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = NetFilterDeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==NetFilterRegisterDevice: %x\n", Status);
