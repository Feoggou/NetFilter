...
#define FILTER_FRIENDLY_NAME        L"NetFilter NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{32699636-13fc-4e58-90e1-7bbcade484a3}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"NetFilter"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\NetFilter"
#define NTDEVICE_STRING             L"\\Device\\NetFilter"
...
DRIVER_DISPATCH NetFilterDispatch;

DRIVER_DISPATCH NetFilterDeviceIoControl;
